...
class SetPasswordResponseMain extends TGResponse {
  SetPassWordResponse _setPasswordResponse = SetPassWordResponse();
  SetPasswordResponseMain();
  SetPasswordResponseMain.fromJson(dynamic json) {
    fromJson(json);
  }
  @override
  fromJson(json) {
    _setPasswordResponse = SetPassWordResponse.fromJson(json);
  }

  SetPassWordResponse skippedresponse() {
    return _setPasswordResponse;
  }
}
...
class SetPassWordResponse {
  ...
  SetPassWordResponse({this.id, this.message, this.data, this.status, this.flag});
