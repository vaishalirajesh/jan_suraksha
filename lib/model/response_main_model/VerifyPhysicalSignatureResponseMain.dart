...
VerifyPhysicalSignatureResponseMain verifyPhysicalSignatureResponseMainFromJson(String str) =>
    VerifyPhysicalSignatureResponseMain.fromJson(json.decode(str));
String verifyPhysicalSignatureResponseMainToJson(VerifyPhysicalSignatureResponseMain data) =>
    json.encode(data.toJson());

class VerifyPhysicalSignatureResponseMain {
  VerifyPhysicalSignatureResponseMain({
    dynamic id,
    String? message,
    List<Data>? data,
    num? status,
  ...
  VerifyPhysicalSignatureResponseMain.fromJson(dynamic json) {
    _id = json['id'];
  ...
  num? _status;
  bool? _flag;
  VerifyPhysicalSignatureResponseMain copyWith({
    dynamic id,
    String? message,
    List<Data>? data,
    num? status,
...
/// pmsbyExists : false
/// kycUpdated : true
/// customerAccountNumber : "4532121201"
/// urnCode : "JNS-PMJJBY-2023-24-101212405-9424"
/// sizeOfACHolder : 1
