...
class GetResponseForSkipEmailMain extends TGResponse {
  GetResponseForSkipEmail _getAllMenuForBankerResponseMain = GetResponseForSkipEmail();

  GetResponseForSkipEmailMain();

  GetResponseForSkipEmailMain.fromJson(dynamic json) {
    fromJson(json);
  }

  @override
  fromJson(json) {
    _getAllMenuForBankerResponseMain = GetResponseForSkipEmail.fromJson(json);
  }

  GetResponseForSkipEmail skippedresponse() {
