      ...
      child: Scaffold(
        ...
        body: Obx(() {
          return AbsorbPointer(
            absorbing: signUpLogic.isLoading.value,
                                ...
                                ? Row(
                                    children: [
                                      SizedBox(
                                          ...
                                          height: 40,
                                          child:
                                              Image.memory(Base64Decoder().convert(signUpLogic.captchaString.value))),
                                      SizedBox(
                                        width: 10,
                                      ),
                                      Icon(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        ...
                                        style: StyleConfig.regularText16.copyWith(
                                            color: ColorConfig.jsBlackColor, fontFamily: JSFonts.outfitRegular),
                                      )
                                    ],
                                  );
                          }),
                                              ...
                                              recognizer: TapGestureRecognizer()
                                                ..onTap = () async {
                                                  Navigator.of(context).push(
                                                      MaterialPageRoute(builder: (context) => MyStatefulWidget("1")));
...
//                                               );
                                          ...
                                          TextSpan(
                                              ...
                                              recognizer: TapGestureRecognizer()
                                                ..onTap = () async {
                                                  Navigator.of(context).push(
                                                      MaterialPageRoute(builder: (context) => MyStatefulWidget("2")));
                                                }),
                                          TextSpan(
                                            text: "and ",
                                            style: StyleConfig.smallText,
                                          ...
                                          TextSpan(
                                              ...
                                              recognizer: TapGestureRecognizer()
                                                ..onTap = () async {
                                                  Navigator.of(context).push(
                                                      MaterialPageRoute(builder: (context) => MyStatefulWidget("3")));
                                                }),
                                        ])),
                                  )),
                            ],
                                    ...
                                    text: TextSpan(
                                      children: [
                                        ...
                                        TextSpan(
                                          text: "Login",
                                          style: StyleConfig.regularText16.copyWith(
                                              color: ColorConfig.jsBlueColor, fontFamily: JSFonts.outfitMedium),
                                        ),
                                      ],
                                    ),
                                  ),
